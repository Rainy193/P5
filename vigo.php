                                ...
                                <div class="col-lg-9 col-12">
                                    <div class="custom-block-info">
                                        <div class="custom-block-top d-flex mb-1">
                                            ...
                                            <small class="ms-auto">Episode <span class="badge">1</span></small>
                                        </div>

                                        <h2 class="mb-2">Yanuar First Giovin</h2>

                                        <p>Haii, Saya <b>Yanuar First Giovin</b>, yang biasa di panggil dengan nama <b>Vigo</b>. Saya adalah siswa jurusan <b>Rekayasa Perangkat Lunak (RPL)</b> yang terjun kedalam dunia teknologi, yang berfokus dalam pengembangan perangkat lunak serta aplikasi.  Selama belajar di jurusan RPL, saya telah mengembangkan keterampilan di bidang pemograman, desain antarmuka, serta manajemen proyek toknologi.</p>

                                        <p>Saya belajar dalam pengembangan aplikasi web yang menggunakan bahasa pemograman/framework. Contohnnya seperti: <b>HTML, CSS, PHP</b>. <br>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="section-title-wrap mb-5">
                                <h4 class="section-title">Our Member</h4>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-12 mb-4 mb-lg-0" id="rasya">
                            <div class="custom-block custom-block-full">
                                <div class="custom-block-image-wrap">
                                    <a href="rasya.php">
