                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-12 pe-lg-5">
                            <div class="contact-info">
                                <h3 class="mb-4">We'd love to know you. Get in touch</h3>

                                <p class="d-flex border-bottom pb-3 mb-4">
                                    <strong class="d-inline me-4">Phone:</strong>
                                    <span>+6282256922172</span>
                                </p>
                                ...
                                <p class="d-flex">
                                    ...
                                    <span>Jl. Soekarno Hatta, Gn. Samarinda, Kec. Balikpapan Utara, Kota Balikpapan, Kalimantan Timur 76125</span>
                                </p>
                            </div>
                        </div>

                        <div class="col-lg-5 col-12 mt-5 mt-lg-0">
                            <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d997.2229163627617!2d116.84344239649107!3d-1.2348906077871398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df148c944618985%3A0x6e5c97bc73558481!2sSMK%20Negeri%202%20Balikpapan!5e0!3m2!1sid!2sid!4v1726824796744!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            <form action="config/app.php" method="post" class="custom-form contact-form" role="form">
                                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <ul class="social-icon">
                            <li class="social-icon-item">
                                <a href="https://www.instagram.com/iteamofc_" class="social-icon-link bi-instagram"></a>
                            </li>
            ...
            <div class="container pt-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-12">
                        <p class="copyright-text mb-0">Copyright © 2036 SIGMA CORPS
                        <br><br>
