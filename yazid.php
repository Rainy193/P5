                                ...
                                <div class="col-lg-9 col-12">
                                    <div class="custom-block-info">
                                        <div class="custom-block-top d-flex mb-1">
                                            ...
                                            <small class="ms-auto">Episode <span class="badge">9</span></small>
                                        </div>

                                        <h2 class="mb-2">Yazid AL-Baihaqi </h2>

                                        <p>Halo semuanya, nama Saya Yazid AL-Baihaqi, yang biasa di panggil dengan nama yazid. Saya adalah siswa jurusan Rekayasa Perangkat Lunak (RPL) 
                                            yang terjun kedalam dunia teknologi, yang berfokus dalam pengembangan perangkat lunak serta aplikasi.  
                                            Selama belajar di jurusan RPL, saya telah mengembangkan keterampilan di bidang pemograman, 
                                            desain antarmuka, serta manajemen proyek toknologi.
                                        </p>
                                        ...
                                        <p>Bagi saya, belajar teknologi itu seperti tantangan seru yang tidak akan ada habisnya. 
                                            Saya selalu tertarik untuk memecahkan masalah dengan cara-cara kreatif dan praktis, 
                                            serta berkolaborasi dengan teman-teman untuk menciptakan solusi yang bisa bermanfaat. 
                                            Serta saya dapat mengembangkan ide untuk membuat sebuah web yang dapat di gunakan oleh 
                                            orang lain. Hubungi saya jika tertarik dan untuk diskusi lebih lanjut
                                        </p>

                                        <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                            <div class="d-flex mb-3 mb-lg-0 mb-md-0">
                                                <img src="images/profile/yazid.png" class="profile-block-image img-fluid" alt="">
                                            ...
                                            <ul class="social-icon ms-lg-auto ms-md-auto">
                                                <li class="social-icon-item">
                                                    <a href="https://www.instagram.com/sipaling_offlaner?igsh=MWN1MnFkZGlndGp5dA==" class="social-icon-link bi-instagram"></a>
                                                </li>

                                                <li class="social-icon-item">
                                                    <a href="https://wa.me/+6285751926272" class="social-icon-link bi-whatsapp"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
                        ...
                        <p class="mb-2"><strong class="d-inline me-2">Phone:</strong>+62 857-5192-6272</p>

                        <p>
                            <strong class="d-inline me-2">Email:</strong>
                            <a href="#">yazidalbaihaqi788@gmail.com</a> 
                        </p>
                    </div>
