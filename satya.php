                                ...
                                <div class="col-lg-9 col-12">
                                    <div class="custom-block-info">
                                        <div class="custom-block-top d-flex mb-1">
                                            ...
                                            <small class="ms-auto">Episode <span class="badge">6</span></small>
                                        </div>

                                        <h2 class="mb-2">Satya Rizky Nugraha</h2>

                                        <p>Haii, Saya Satya Rizky Nugraha, yang biasa di panggil dengan nama Kevin. Saya adalah siswa jurusan Rekayasa Perangkat Lunak (RPL) yang terjun kedalam dunia teknologi, yang berfokus dalam pengembangan perangkat lunak serta aplikasi.  Selama belajar di jurusan RPL, saya telah mengembangkan keterampilan di bidang pemograman, desain antarmuka, serta manajemen proyek toknologi.</p>

                                        <p>Saya belajar dalam pengembangan aplikasi web yang menggunakan bahasa pemograman/framework. Contohnnya seperti: HTML, CSS, PHP. <br>
                                            Saya juga belajar basis data menggunakan MySQL & MariaDB serta belajar mengoprasikan server menggunakan Linux. <br>
                                            Dan kemampuan saya dalam problem solving meningkat selama saya belajar di jurusan RPL
                                        ...
                                        <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                            ...
                                            <ul class="social-icon ms-lg-auto ms-md-auto">
                                                <li class="social-icon-item">
                                                    <a href="https://www.instagram.com/saaactuary/?utm_source=ig_web_button_share_sheet" class="social-icon-link bi-instagram"></a>
                                                </li>

                                                <li class="social-icon-item">
                                                    <a href="https://wa.me/+6281347112971" class="social-icon-link bi-whatsapp"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
                        ...
                        <p class="mb-2"><strong class="d-inline me-2">Phone:</strong>+6281347112971</p>

                        <p>
                            <strong class="d-inline me-2">Email:</strong>
                            <a href="#">satyarizky2502@gmail.com</a> 
                        </p>
                    </div>
