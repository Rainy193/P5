            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand me-lg-5 me-0" href="index.html">
                        <img src="images/loggoo-removebg-preview.png" class="logo-image img-fluid" alt="templatemo pod talk">
                    </a>
                                ...
                                <div class="col-lg-9 col-12">
                                    <div class="custom-block-info">
                                        <div class="custom-block-top d-flex mb-1">
                                            ...
                                            <small class="ms-auto">Member <span class="badge">8</span></small>
                                        </div>

                                        <h2 class="mb-2">Hidjrah Zlatan Almovic</h2>

                                        <p>Haii, <b>Hidjrah Zlatan Almovic</b>, yang biasa di panggil dengan nama <b>AL</b>. Saya adalah siswa jurusan Rekayasa Perangkat Lunak (RPL) yang terjun kedalam dunia teknologi, yang berfokus dalam pengembangan perangkat lunak serta aplikasi.  Selama belajar di jurusan RPL, saya telah mengembangkan keterampilan di bidang pemograman, desain antarmuka, serta manajemen proyek toknologi</p>

                                        <p>Kemampuan diri yang saya punya adalah suka <b>Matematika</b> dan suka mencoba hal baru , Suka bermain <b>Rubik's Cube</b> dan suka Mendengarkan <b>Musik</b></p>

                                        <p>Saya belajar dalam pengembangan aplikasi web yang menggunakan bahasa pemograman/framework. Contohnnya seperti: <b>HTML, CSS, PHP</b>.</p>
                                        ...
                                        <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                            ...
                                            <ul class="social-icon ms-lg-auto ms-md-auto">
                                                <li class="social-icon-item">
                                                    <a href="https://www.instagram.com/al_editzxy" class="social-icon-link bi-instagram"></a>
                                                </li>

                                                <li class="social-icon-item">
                                                    <a href="https://wa.me/+6282157521904" class="social-icon-link bi-whatsapp"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
                        ...
                        <p class="mb-2"><strong class="d-inline me-2">Phone:</strong>+6282157521904</p>

                        <p>
                            <strong class="d-inline me-2">Email:</strong>
                            <a href="#">duljumaidinhiguain@gmail.com</a> 
                        </p>
                    </div>
