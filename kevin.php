                                ...
                                <div class="col-lg-9 col-12">
                                    <div class="custom-block-info">
                                        <div class="custom-block-top d-flex mb-1">
                                            ...
                                            <small class="ms-auto">Episode <span class="badge">3</span></small>
                                        </div>

                                        <h2 class="mb-2">Kevin Timothy Adiel</h2>

                                            <p>Haloo, Saya Kevin Timothy Adiel, yang biasa di panggil dengan nama Kevin. Saya adalah siswa jurusan Rekayasa Perangkat Lunak (RPL) yang terjun kedalam dunia teknologi, yang berfokus dalam pengembangan perangkat lunak serta aplikasi.  Selama belajar di jurusan RPL, saya telah mengembangkan keterampilan di bidang pemograman, desain antarmuka, serta manajemen proyek toknologi.</p>
                                        ...
                                        <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                            ...
                                            <ul class="social-icon ms-lg-auto ms-md-auto">
                                                <li class="social-icon-item">
                                                    <a href="https://www.instagram.com/dielll19/" class="social-icon-link bi-instagram"></a>
                                                </li>

                                                <li class="social-icon-item">
                                                    <a href="https://wa.me/+6285174458819" class="social-icon-link bi-whatsapp"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-md-0 mb-lg-0">
                        ...
                        <p class="mb-2"><strong class="d-inline me-2">Phone:</strong>+6285174458819</p>

                        <p>
                            <strong class="d-inline me-2">Email:</strong>
                            <a href="#">ktimothy776@gmail.com</a> 
                        </p>
                    </div>
